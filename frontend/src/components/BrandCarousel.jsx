...
const brands = [
    ...
    { name: 'BBVA', img: getImagePath('bbva.svg'), invertible: false, wide: true },
    ...
    { name: 'Estrella Damm', img: getImagePath('estrella-damm.svg'), invertible: true, wide: false },
    { name: 'Barceló', img: getImagePath('barcelo.png'), invertible: true, wide: true },
    { name: 'Mercadona', img: getImagePath('Mercadona.svg'), invertible: false, wide: true },
    { name: 'Unión Europea', img: getImagePath('union-europea.svg'), invertible: false, wide: true },
    { name: 'Ministerio de Hacienda', img: getImagePath('ministerio-hacienda.svg'), invertible: false, wide: true },
    { name: 'Junta de Andalucía', img: getImagePath('junta-andalucia.svg'), invertible: false, wide: false },
    ...
    { name: 'Bechtle', img: getImagePath('bechtle.svg'), invertible: false, wide: true },
    { name: 'Bliss', img: getImagePath('bliss.png'), invertible: true, wide: true },
    { name: 'Desalia', img: getImagePath('desalia.png'), invertible: false, wide: true },
    { name: 'Farma Leaders Talento', img: getImagePath('farma-leaders-talento.png'), invertible: false, wide: true },
];
